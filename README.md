...
This guarantees consistent coordinate alignment across all layers.
...
This bridge intentionally separates:
...
The NT script defines meaning.
The Pi translates and renders.
The Grid becomes a physical UI surface.

This separation keeps the instrument scalable and predictable.
